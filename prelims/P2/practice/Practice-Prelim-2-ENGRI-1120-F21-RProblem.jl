...
* Neither of the chemical reactions occurs in the streams
...
* If $\hat{r}_{1}$ and $\hat{r}_{2}$ and irreversible, and first-order in $A$, compute the forward rate constants $k_{1}$ and $k_{2}$ for reaction 1 and 2, respectively. 
