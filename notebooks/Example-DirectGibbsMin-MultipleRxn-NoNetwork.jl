...
# ╔═╡ e49cd86f-49b5-4a1b-b59c-286c885f5477
begin
	using LinearAlgebra
	using PlutoUI
	using PrettyTables
...
# ╔═╡ eb9210c4-53bd-42c0-b9f7-370cd729f97b
md"""
#### Example: Network Free Direct Gibbs Energy Minimization for Multiple Reactions
"""

# ╔═╡ 37ef20a4-8833-44aa-8a60-55966ca0f526
# conversion factor -
ΔG_sf = 1e9; # convert to mol to *mol

# ╔═╡ 9fdb76d6-d9d1-4767-af9c-d9e3516dd867
R = 8.314*(1/1000)*(1/ΔG_sf); # units: kJ/nmol-K

# ╔═╡ 3c19b764-48b2-41d0-af01-3dfffad4e97b
T = 37.0 + 273.15; # units: K

# ╔═╡ 22baad08-d8fe-4fef-8695-29dfb19719ad
V = 30*(1/1e6); # units: L

# ╔═╡ f9146436-148b-477e-8c17-968e5badc5fb
function objective_function(n_array, parameters)
	...
	# compute term_1 -
	term_1 = sum(n_array.*G_formation_array)

	# compute term_2 -
	n_total = sum(n_array)
	log_terms = log.((1/n_total)*n_array)
	term_2 = RT*sum(n_array.*log_terms)

	# compute penalty terms -
	penalty_terms = 0

	# return -
	return (term_1 + term_2 + penalty_terms)
end

# ╔═╡ 4d820a24-0dd7-41f5-a972-d2a7c84d7d65
begin
	...
	# what are my initial condtions in terms of atoms -
...
# ╔═╡ 36bda23e-3b2f-11ec-1674-cf0ec4bc6598
html"""
<style>
main {
    max-width: 1200px;
