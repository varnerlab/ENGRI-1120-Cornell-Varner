...
# ╔═╡ 5b32481c-1653-443f-85ff-a84a9f2cd000
using Plots

# ╔═╡ bc3df3e4-1476-11ec-1c69-dbf58e5026c1
md"""
...
# ╔═╡ 48aa78a3-90c9-49ff-958b-44810773b30e
# lifetime = 3 future years (period of time to payback the investment)
T = 3

# ╔═╡ 82ad506d-05e0-4166-9588-4551825a0724
...
discount_rate = 0.08465

# ╔═╡ 92df851c-d478-4a17-adeb-ddd4e54fb310
# Setup the cash flow array -
# we pay in year 1: $230K (out, -ve)
# we save in year(s) 2,3 and 4: 90K (in,+ve)
CF_array = [-230.0, 90.0, 90.0, 90.0]

# ╔═╡ b6f8a676-58cc-4dc9-9e8d-f61d07747e8c
...
# ╔═╡ 339f4322-cb19-418d-9b30-801712381355
# what is the PV?
PV = CF_array.*(1.0./discount_array)

# ╔═╡ 3a884326-52a0-4442-b1e7-6c7054d4a865
# what is the NPV?
NPV = sum(PV)

# ╔═╡ a5d5a623-2ece-494e-b284-a264e759c07a
md"""
#### How do I interpret the NPV? 

If the NPV is postive, then project would be a good investment versus the alternative of investing the 230K USD growing risk free at the discount rate. You can play with the discount rate to see what ranges make the propsed project a good investment.
"""

# ╔═╡ 1b5605f8-c2b6-4552-bc0b-e4d45393315f
html"""<style>
main {
    max-width: 1200px;
  	width: 80%;
